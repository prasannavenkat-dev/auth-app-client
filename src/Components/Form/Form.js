    ...
    <div className="login-signup-container" style={{ background: "inherit" }}>
      <div className="login-signup">
        <div className="header">
          ...
          {
            resetPass ? <h1> <span>Reset Password</span></h1> : <h1>{signUp ? <span>Sign Up</span> : <span>Sign In</span>}</h1>
          }
        </div>
        <div style={{ height: resetPass && "60px", marginBottom: resetPass && "40px" }}>
          <input type="text" style={{ height: resetPass && "45px", marginBottom: resetPass && "10px" }} name="email" placeholder="Email" value={userInfo.email} onChange={userInfoHandle} />
      ...
      <CustomSnackbar  handleCloseSnackbar={handleCloseSnackbar} snackbarInfo={snackbarInfo} setSnackbarInfo={setSnackbarInfo} openSnackbar={openSnackbar} setOpenSnackBar={setOpenSnackBar} />
    </div>
  );
};
